...
//<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	var host="http://usersystem.dlgtech.cn/yj-mer/";
	var regUrl=host+"MerChants/mergeOrInsertForHtml.shtml";
	var bindUrl=host+"MerChants/setMerChantsForHtml.shtml";
	...
	function login(){
		var code=$("#code").val();
		$.ajax({
			url : loginUrl+"?merMp="+myphone+"&merChantId="+merChantId +"&identifying=" + code+"&appId="+appId,
			type : 'POST',
	...
	function toBind(){
		//看似是注册，其实是绑定
		$.ajax({
			url : bindUrl+"?merMp="+phone+"&merChantId="+merChantId+"&appId="+appId,
			type : 'POST',
